...
func (a *OnlineApp) Init(cfg map[string]interface{}) error {
...
func (d *OnlineApp) Start(ctx context.Context) {
...
// 选主，返回本地是否为主备
func (d *OnlineApp) VoteMain(ctx context.Context) bool {
	// 获取实际主备
	leaseAppId := ""
...
func Run(ctx context.Context) error {
	runtime.Run(ctx, newApp(), []server.Server{onlineser.New()})
	return nil
}
